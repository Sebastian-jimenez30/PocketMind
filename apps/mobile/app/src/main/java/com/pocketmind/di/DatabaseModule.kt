...
object DatabaseModule {
    ...
    @Provides fun provideBudgetDao(database: PocketMindDatabase): BudgetDao = database.budgetDao()
    @Provides fun provideCustomCategoryDao(database: PocketMindDatabase): CustomCategoryDao = database.customCategoryDao()
}
